...
function test_character_classes()
  ...
  -- since this uses substring above, character classes as checked
  -- note I used different string types to work them out
...
function test_one_or_none()
  -- different than other languages.  I would have expected 'is'
